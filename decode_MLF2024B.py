...
def readfile(inputfiles = ["list_000008_01-00000000001.bin"], ENum = -1, datadir="C:\Data/TMU2022C/list/", outdir="C:\Data/TMU2022C/pdf/", outname="SDD_ene.pdf", cal_source=""):
  ...
  ax2[2].hist(eners_wG, bins=500, range=[10.,25.],histtype='step',color='r', label='w/ Gate (zoom)')
...
if __name__ == "__main__":
    ...
    readfile(inputfiles =inputfiles, ENum = -1, datadir="C:\Data/MLF2024B/list/", outdir="C:\Data/MLF2024B/pdf/", outname="SDD_ene_MLF_run{0:04d}_{1:04d}.pdf".format(irun, frun),  cal_source="muAr")
